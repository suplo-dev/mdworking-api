...
class QueryAdsGoogleService
{
    public function __construct(private readonly AdsGoogleRepository $adsGoogleRepository)
    {
    }
    ...
    public function search(array $params): LengthAwarePaginator
    {
        ...
        return $this->adsGoogleRepository->search($params);
    }
